...
# Github : https://github.com/kazisamur4
...
\033[1;92m [ ] kazi samir IT'
 \033[1;97m___________________________________________
"""
    psb ('\n\x1b[1;91m\n [1]  K4US4R  \033[96;5m[BYPASS]')
    psb ('\n\x1b[1;92m [2]  RIYAD-RR \033[96;5m[BYPASS]')
    psb ('\n\x1b[1;93m [3]  SHANTO \033[96;5m[BYPASS]')
    psb ('\n\x1b[1;94m [4] RANJHA \033[96;5m[BYPASS]')
    psb ('\n\x1b[1;95m [5]  MAHIN \033[96;5m[BYPASS]')
